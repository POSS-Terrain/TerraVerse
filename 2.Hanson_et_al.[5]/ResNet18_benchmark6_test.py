...
# ==============================================================================
parser = argparse.ArgumentParser(description="ResNet18 纯测试脚本")
...
parser.add_argument("--ckpt_path", type=str, 
                    default="/8TBHDD3/tht/TerraX/7Hanson_et_al./resnet18_checkpoints/benchmark1/exp2/resnet18_traversable_best.pth", 
                    help="训练好的 ResNet18 模型权重路径")
...
def main(args):
    ...
    print(f"\n=======================================================")
    print(f"🚀 启动 ResNet18 测试: {args.exp_name} | 使用设备: GPU {args.gpu}")
    ...
    csv_filename = f"{args.exp_name}_resnet18_inference_results.csv"
