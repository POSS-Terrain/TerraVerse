...
# ==============================================================================
parser = argparse.ArgumentParser(description="多卡并发训练 DINOv2 Baseline (Benchmark 3)")
...
CONFIG = {
    ...
    "num_workers": 8,
    "img_size": 224,
    "save_dir": "./dinov2_checkpoints", # 新增：为 DINOv2 独立设置的保存目录
...
def main(args):
    ...
    print(f"\n=======================================================")
    print(f"🚀 启动 DINOv2 实验: {args.exp_name} | GPU: {args.gpu}")
    print(f"=======================================================\n")
    ...
    # =========================================================================
    print("\n=======================================================")
    print("📊 Benchmark 3: Robust Classification Final Results (DINOv2)")
    print("=======================================================")
